      ...
      <section className="mt-30 bg-[#F1F1F1] p-10">
        ...
        <div className="flex gap-5 flex-wrap">
          <span className="flex flex-col justify-center h-[356px] w-[calc(33.333%-1.25rem)] bg-white p-10 gap-4 ">
            ...
            <p className="font-bold font-manrope text-xl">Wallet-Based Login</p>
            <p className="font-medium font-manrope">
              Connect with MetaMask or any wallet to verify and own your work—no
              passwords needed.
            </p>
          </span>
          ...
          <span className="flex flex-col justify-center h-[356px] w-[calc(33.333%-1.25rem)] bg-white p-10 gap-4">
            ...
            <p className="font-medium font-manrope">
              Secure digital signatures from clients provide authentic proof of
              work completion.
            </p>
          </span>
          ...
          <span className="flex flex-col justify-center h-[356px] w-[calc(33.333%-1.25rem)] bg-white p-10 gap-4">
            ...
            <p className="font-bold font-manrope text-xl"> Instant Minting </p>
            <p className="font-medium font-manrope">
              Automated NFT creation upon client verification with low gas fees
              and fast processing.
            </p>
          </span>
          ...
          <span className="flex flex-col justify-center h-[356px] w-[calc(33.333%-1.25rem)] bg-white p-10 gap-4">
            ...
            <p className="font-bold font-manrope text-xl"> Easy Integration </p>
            <p className="font-medium font-manrope">
